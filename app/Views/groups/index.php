        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a href="<?= site_url('groups/trash') ?>" class="btn btn-danger">
                        <i class="fa fa-trash">
                            Trash</i>
                    </a>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="width:15% ;">
                                <a
                                    href="<?= site_url('groups/edit/'.$value->id_group) ?>"
                                    class="btn btn-warning btn-sm">
                                    <i class="fas fa-pencil-alt"></i>
                                </a>
                                <form
                                    action="<?= site_url('groups/delete/'.$value->id_group) ?>"
                                    method="POST"
                                    class="d-inline"
                                    id="del-<?= $value->id_group ?>">
                                    <?= csrf_field() ?>
